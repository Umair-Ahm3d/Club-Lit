...
{/* 🎮 Club Hub */}
<section className="homepage-clubs">
        <div className="section-header">
          <h2 className="section-title">Recommended Clubs</h2>
          <button className="see-all-btn" onClick={() => navigate("/club")} style={{ cursor: "pointer", marginLeft: "10px" }}>&gt;&gt;&gt;</button>
        </div>
      ...
      <section className="recommendation-section">
        <div className="section-header">
          ...
          <button className="see-all-btn" onClick={() => navigate("/genre")} style={{ cursor: "pointer", marginLeft: "10px" }}>&gt;&gt;&gt;</button>
        </div>
        <div className="section-divider"></div>
